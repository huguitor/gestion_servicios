...
class ConfiguracionService:
    ...
    def obtener_config_login():
        ...
        Logo Portal Web:
        - Usa logo_tkinter por compatibilidad.
        - Si no existe, utiliza logo_principal.
        """
        ...
        return {
            ...
            "logo_url": (
                ...
                if config.logo_tkinter_url
                else config.logo_principal_url
            ),

            "modulos": license_manager.modules(),
        }

    @staticmethod
    def obtener_logos_para_pdf():
        """Obtener imágenes utilizadas en PDFs."""
        config = ConfiguracionService.obtener_configuracion()

        return {
            "logo_principal": config.logo_principal_url,
