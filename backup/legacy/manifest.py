...
MODEL_MAPPINGS = (
    ...
    _import("configuracion_configuracionglobal", "configuracion.ConfiguracionGlobal", 2, "configuracion.ConfiguracionImporter"),
    _import("impuestos_impuesto", "impuestos.Impuesto", 2, "impuestos.ImpuestosImporter"),
    _import("categorias_categoria", "categorias.Categoria", 2, "categorias.CategoriasImporter"),
    _import("marcas_marca", "marcas.Marca", 2, "marcas.MarcasImporter"),
    _import(
    ...
    _import(
        ...
        3,
        "proveedores.ProveedoresImporter",
    ),
    _import(
        "productos_producto",
        "productos.Producto",
        4,
        "productos.ProductosImporter",
    ...
    _import(
        ...
        "admin.LogEntry",
        16,
        "admin_history.AdminLogImporter",
